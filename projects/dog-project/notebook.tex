...
/home/ubuntu/anaconda3/envs/tensorflow\_p36/lib/python3.6/importlib/\_bootstrap.py:219: RuntimeWarning: compiletime version 3.5 of module 'tensorflow.python.framework.fast\_tensor\_util' does not match runtime version 3.6
  return f(*args, **kwds)
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
lfw/Jane\_Pauley/Jane\_Pauley\_0002.jpg
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{human\PYZus{}files\PYZus{}short} \PY{o}{=} \PY{n}{human\PYZus{}files}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{100}\PY{p}{]}
        ...
        \PY{n}{human\PYZus{}detected\PYZus{}count} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{dog\PYZus{}detected\PYZus{}count} \PY{o}{=} \PY{l+m+mi}{0}
        
        \PY{k}{for} \PY{n}{human} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{:}
            \PY{k}{if} \PY{n}{face\PYZus{}detector}\PY{p}{(}\PY{n}{human}\PY{p}{)}\PY{p}{:}
                \PY{n}{human\PYZus{}detected\PYZus{}count} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
        \PY{c+c1}{\PYZsh{} print(human\PYZus{}detected\PYZus{}count)}
        
        \PY{k}{for} \PY{n}{dog} \PY{o+ow}{in} \PY{n}{dog\PYZus{}files\PYZus{}short}\PY{p}{:}
            \PY{k}{if} \PY{n}{face\PYZus{}detector}\PY{p}{(}\PY{n}{dog}\PY{p}{)}\PY{p}{:}
                \PY{n}{dog\PYZus{}detected\PYZus{}count} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
        \PY{c+c1}{\PYZsh{} print(dog\PYZus{}detected\PYZus{}count)}
        
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Of 100 human files }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ were detected as human faces}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{human\PYZus{}detected\PYZus{}count}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Of 100 dog files }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ were detected as human faces}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{dog\PYZus{}detected\PYZus{}count}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Of 100 human files 98 were detected as human faces
Of 100 dog files 11 were detected as human faces
...
No, accepting only images that have a clear front on view of a face is
not a reasonable expectation to ask users. We should strive for greater
generalization. One strategy could be image augmentation: rotating,
translating, and otherwise distorting the original images to create more
training data that is imperfect. Training on more imperfect data will
help the algorithm generalize.
...
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Test the performance of the dog\PYZus{}detector function}
         ...
         \PY{k}{for} \PY{n}{human} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{:}
             \PY{k}{if} \PY{n}{dog\PYZus{}detector}\PY{p}{(}\PY{n}{human}\PY{p}{)}\PY{p}{:}
                 \PY{n}{human\PYZus{}detected\PYZus{}count} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
         \PY{c+c1}{\PYZsh{} print(human\PYZus{}detected\PYZus{}count)}
         
         \PY{k}{for} \PY{n}{dog} \PY{o+ow}{in} \PY{n}{dog\PYZus{}files\PYZus{}short}\PY{p}{:}
             \PY{k}{if} \PY{n}{dog\PYZus{}detector}\PY{p}{(}\PY{n}{dog}\PY{p}{)}\PY{p}{:}
                 \PY{n}{dog\PYZus{}detected\PYZus{}count} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
         \PY{c+c1}{\PYZsh{} print(dog\PYZus{}detected\PYZus{}count)}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Of 100 human files }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ were detected as dog faces}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{human\PYZus{}detected\PYZus{}count}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Of 100 dog files }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ were detected as dog faces}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{dog\PYZus{}detected\PYZus{}count}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Of 100 human files 1 were detected as dog faces
Of 100 dog files 100 were detected as dog faces
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|██████████| 6680/6680 [00:53<00:00, 124.72it/s]
100\%|██████████| 835/835 [00:05<00:00, 140.30it/s]
100\%|██████████| 836/836 [00:05<00:00, 141.74it/s]
...
I decided to follow the architecture outlined in Udacity's lecture on
CNN for image recognition. I thought increasing to 64 filters would be
useful since their is so much intra class variation to account for (more
filters to handle specific class attributes). Increasing to such a large
amount of filters creates very large numbers of parameters so having a
max pooling layer after each convulutional layer was necessary. Using a
pool size of 2 cuts the amount of spatial data in half each time.
...
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dense\_1 (Dense)              (None, 1000)              50177000  
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dense\_2 (Dense)              (None, 133)               133133    
=================================================================
Total params: 50,320,677
Trainable params: 50,320,677
...
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{n}{model}\PY{o}{.}\PY{n}{compile}\PY{p}{(}\PY{n}{optimizer}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rmsprop}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{loss}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{categorical\PYZus{}crossentropy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{metrics}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
the training data}, but this is not a requirement.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{k+kn}{from} \PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{callbacks} \PY{k}{import} \PY{n}{ModelCheckpoint}  
...
Epoch 1/5
6660/6680 [============================>.] - ETA: 0s - loss: 4.8942 - acc: 0.0278Epoch 00001: val\_loss improved from inf to 4.31779, saving model to saved\_models/weights.best.from\_scratch.hdf5
6680/6680 [==============================] - 67s 10ms/step - loss: 4.8925 - acc: 0.0280 - val\_loss: 4.3178 - val\_acc: 0.0587
Epoch 2/5
6660/6680 [============================>.] - ETA: 0s - loss: 3.9710 - acc: 0.1119Epoch 00002: val\_loss improved from 4.31779 to 4.07532, saving model to saved\_models/weights.best.from\_scratch.hdf5
6680/6680 [==============================] - 66s 10ms/step - loss: 3.9708 - acc: 0.1120 - val\_loss: 4.0753 - val\_acc: 0.0934
Epoch 3/5
6660/6680 [============================>.] - ETA: 0s - loss: 2.6197 - acc: 0.3770Epoch 00003: val\_loss did not improve
6680/6680 [==============================] - 63s 9ms/step - loss: 2.6191 - acc: 0.3775 - val\_loss: 4.6251 - val\_acc: 0.1030
Epoch 4/5
6660/6680 [============================>.] - ETA: 0s - loss: 0.7991 - acc: 0.8011Epoch 00004: val\_loss did not improve
6680/6680 [==============================] - 63s 9ms/step - loss: 0.7975 - acc: 0.8015 - val\_loss: 6.4266 - val\_acc: 0.0778
Epoch 5/5
6660/6680 [============================>.] - ETA: 0s - loss: 0.1618 - acc: 0.9605Epoch 00005: val\_loss did not improve
6680/6680 [==============================] - 63s 10ms/step - loss: 0.1613 - acc: 0.9606 - val\_loss: 8.0855 - val\_acc: 0.0886

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}26}]:} <keras.callbacks.History at 0x7f28580faac8>
\end{Verbatim}
...
Loss}\label{load-the-model-with-the-best-validation-loss}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{model}\PY{o}{.}\PY{n}{load\PYZus{}weights}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{saved\PYZus{}models/weights.best.from\PYZus{}scratch.hdf5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
Features}\label{obtain-bottleneck-features}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{bottleneck\PYZus{}features} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bottleneck\PYZus{}features/DogVGG16Data.npz}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
category and is equipped with a softmax.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{VGG16\PYZus{}model} \PY{o}{=} \PY{n}{Sequential}\PY{p}{(}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{n}{checkpointer} \PY{o}{=} \PY{n}{ModelCheckpoint}\PY{p}{(}\PY{n}{filepath}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{saved\PYZus{}models/weights.best.VGG16.hdf5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} 
                                        \PY{n}{verbose}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{save\PYZus{}best\PYZus{}only}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
Train on 6680 samples, validate on 835 samples
Epoch 1/20
6520/6680 [============================>.] - ETA: 0s - loss: 11.7439 - acc: 0.1391Epoch 00001: val\_loss improved from inf to 10.11278, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 2s 280us/step - loss: 11.6787 - acc: 0.1428 - val\_loss: 10.1128 - val\_acc: 0.2180
Epoch 2/20
6520/6680 [============================>.] - ETA: 0s - loss: 9.3174 - acc: 0.3063Epoch 00002: val\_loss improved from 10.11278 to 9.25143, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 1s 215us/step - loss: 9.2948 - acc: 0.3081 - val\_loss: 9.2514 - val\_acc: 0.3114
Epoch 3/20
6520/6680 [============================>.] - ETA: 0s - loss: 8.6308 - acc: 0.3802Epoch 00003: val\_loss improved from 9.25143 to 8.90965, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 1s 216us/step - loss: 8.6541 - acc: 0.3793 - val\_loss: 8.9097 - val\_acc: 0.3365
Epoch 4/20
6640/6680 [============================>.] - ETA: 0s - loss: 8.3614 - acc: 0.4193Epoch 00004: val\_loss improved from 8.90965 to 8.76236, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 2s 228us/step - loss: 8.3583 - acc: 0.4195 - val\_loss: 8.7624 - val\_acc: 0.3689
Epoch 5/20
6500/6680 [============================>.] - ETA: 0s - loss: 8.1958 - acc: 0.4502Epoch 00005: val\_loss improved from 8.76236 to 8.68822, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 1s 215us/step - loss: 8.2029 - acc: 0.4496 - val\_loss: 8.6882 - val\_acc: 0.3725
Epoch 6/20
6520/6680 [============================>.] - ETA: 0s - loss: 8.1208 - acc: 0.4646Epoch 00006: val\_loss did not improve
6680/6680 [==============================] - 1s 211us/step - loss: 8.1278 - acc: 0.4632 - val\_loss: 8.7377 - val\_acc: 0.3760
Epoch 7/20
6520/6680 [============================>.] - ETA: 0s - loss: 8.0473 - acc: 0.4744Epoch 00007: val\_loss improved from 8.68822 to 8.62367, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 1s 217us/step - loss: 7.1182 - acc: 0.5491 - val\_loss: 7.7850 - val\_acc: 0.4563
Epoch 18/20
6520/6680 [============================>.] - ETA: 0s - loss: 7.0724 - acc: 0.5549Epoch 00018: val\_loss did not improve
6680/6680 [==============================] - 1s 213us/step - loss: 7.0773 - acc: 0.5546 - val\_loss: 7.9292 - val\_acc: 0.4407
Epoch 19/20
6500/6680 [============================>.] - ETA: 0s - loss: 7.0387 - acc: 0.5563Epoch 00019: val\_loss improved from 7.78497 to 7.77753, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 1s 215us/step - loss: 7.0402 - acc: 0.5563 - val\_loss: 7.7775 - val\_acc: 0.4395
Epoch 20/20
6520/6680 [============================>.] - ETA: 0s - loss: 6.8860 - acc: 0.5603Epoch 00020: val\_loss improved from 7.77753 to 7.71994, saving model to saved\_models/weights.best.VGG16.hdf5
6680/6680 [==============================] - 1s 215us/step - loss: 6.8886 - acc: 0.5602 - val\_loss: 7.7199 - val\_acc: 0.4551

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}32}]:} <keras.callbacks.History at 0x7f2850039d68>
\end{Verbatim}
...
Loss}\label{load-the-model-with-the-best-validation-loss}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{n}{VGG16\PYZus{}model}\PY{o}{.}\PY{n}{load\PYZus{}weights}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{saved\PYZus{}models/weights.best.VGG16.hdf5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
test dataset of dog images. We print the test accuracy below.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} get index of predicted dog breed for each image in test set}
...
Model}\label{predict-dog-breed-with-the-model}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{k+kn}{from} \PY{n+nn}{extract\PYZus{}bottleneck\PYZus{}features} \PY{k}{import} \PY{o}{*}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Obtain bottleneck features from another pre\PYZhy{}trained CNN.}
...
I used a global average pooling layer with the shape of the resnet50
input which is 2048 layers deep. This large amount of layers should
provide good results. I then used a dense layer with a size of 133 - for
the 133 dog breeds.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Define your architecture}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{train\PYZus{}Resnet50}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{)}
...
Model}\label{implementation-compile-the-model}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Compile the model.}
...
Train on 6680 samples, validate on 835 samples
Epoch 1/20
6620/6680 [============================>.] - ETA: 0s - loss: 1.6652 - acc: 0.5955Epoch 00001: val\_loss improved from inf to 0.72444, saving model to saved\_models/weights.best.Resnet50.hdf5
6680/6680 [==============================] - 2s 252us/step - loss: 1.6593 - acc: 0.5970 - val\_loss: 0.7244 - val\_acc: 0.7677
Epoch 2/20
6600/6680 [============================>.] - ETA: 0s - loss: 0.4362 - acc: 0.8630Epoch 00002: val\_loss improved from 0.72444 to 0.70615, saving model to saved\_models/weights.best.Resnet50.hdf5
6680/6680 [==============================] - 1s 187us/step - loss: 0.4408 - acc: 0.8624 - val\_loss: 0.7061 - val\_acc: 0.7904
Epoch 3/20
6620/6680 [============================>.] - ETA: 0s - loss: 0.2632 - acc: 0.9148Epoch 00003: val\_loss improved from 0.70615 to 0.66452, saving model to saved\_models/weights.best.Resnet50.hdf5
6600/6680 [============================>.] - ETA: 0s - loss: 0.0092 - acc: 0.9980Epoch 00015: val\_loss did not improve
6680/6680 [==============================] - 1s 184us/step - loss: 0.0091 - acc: 0.9981 - val\_loss: 0.8855 - val\_acc: 0.8287
Epoch 16/20
6580/6680 [============================>.] - ETA: 0s - loss: 0.0083 - acc: 0.9980Epoch 00016: val\_loss did not improve
6680/6680 [==============================] - 1s 184us/step - loss: 0.0082 - acc: 0.9981 - val\_loss: 0.8420 - val\_acc: 0.8251
Epoch 17/20
6580/6680 [============================>.] - ETA: 0s - loss: 0.0070 - acc: 0.9980Epoch 00017: val\_loss did not improve
6680/6680 [==============================] - 1s 184us/step - loss: 0.0069 - acc: 0.9981 - val\_loss: 0.9302 - val\_acc: 0.8251
Epoch 18/20
6600/6680 [============================>.] - ETA: 0s - loss: 0.0062 - acc: 0.9986Epoch 00018: val\_loss did not improve
6680/6680 [==============================] - 1s 184us/step - loss: 0.0063 - acc: 0.9987 - val\_loss: 0.9024 - val\_acc: 0.8275
Epoch 19/20
6620/6680 [============================>.] - ETA: 0s - loss: 0.0060 - acc: 0.9980Epoch 00019: val\_loss did not improve
6680/6680 [==============================] - 1s 183us/step - loss: 0.0059 - acc: 0.9981 - val\_loss: 0.9721 - val\_acc: 0.8192
Epoch 20/20
6600/6680 [============================>.] - ETA: 0s - loss: 0.0069 - acc: 0.9985Epoch 00020: val\_loss did not improve
6680/6680 [==============================] - 1s 184us/step - loss: 0.0068 - acc: 0.9985 - val\_loss: 0.9520 - val\_acc: 0.8144

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}39}]:} <keras.callbacks.History at 0x7f28165f22b0>
\end{Verbatim}
...
Loss}\label{implementation-load-the-model-with-the-best-validation-loss}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Load the model weights with the best validation loss.}
...
\texttt{Xception}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Write a function that takes a path to an image as input}
...
Algorithm}\label{implementation-write-your-algorithm}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Write your algorithm.}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         
         
         \PY{k}{def} \PY{n+nf}{dog\PYZus{}breed\PYZus{}predictor}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{face\PYZus{}detector}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
                 \PY{n}{breed\PYZus{}prediction} \PY{o}{=} \PY{n}{Resnet50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{img}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{A human was detected and it resembles a }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{breed\PYZus{}prediction}\PY{p}{)}\PY{p}{)}
             \PY{k}{elif} \PY{n}{dog\PYZus{}detector}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
                 \PY{n}{breed\PYZus{}prediction} \PY{o}{=} \PY{n}{Resnet50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{img}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{A dog was detected and it resembles a }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{breed\PYZus{}prediction}\PY{p}{)}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Error: Neither a dog or human face were detected.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{k+kn}{from} \PY{n+nn}{IPython}\PY{n+nn}{.}\PY{n+nn}{display} \PY{k}{import} \PY{n}{Image}
         ...
         \PY{n}{human\PYZus{}files\PYZus{}short} \PY{o}{=} \PY{n}{human\PYZus{}files}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}
         \PY{n}{dog\PYZus{}files\PYZus{}short} \PY{o}{=} \PY{n}{train\PYZus{}files}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}
         \PY{c+c1}{\PYZsh{} Do NOT modify the code above this line.}
         \PY{n}{human\PYZus{}detected\PYZus{}count} \PY{o}{=} \PY{l+m+mi}{0}
         \PY{n}{dog\PYZus{}detected\PYZus{}count} \PY{o}{=} \PY{l+m+mi}{0}
         
         \PY{k}{for} \PY{n}{human} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{:}
             \PY{n}{display}\PY{p}{(}\PY{n}{Image}\PY{p}{(}\PY{n}{filename}\PY{o}{=}\PY{n}{human}\PY{p}{)}\PY{p}{)}
             \PY{n}{dog\PYZus{}breed\PYZus{}predictor}\PY{p}{(}\PY{n}{human}\PY{p}{)}
         
         
         \PY{k}{for} \PY{n}{dog} \PY{o+ow}{in} \PY{n}{dog\PYZus{}files\PYZus{}short}\PY{p}{:}
             \PY{n}{display}\PY{p}{(}\PY{n}{Image}\PY{p}{(}\PY{n}{filename}\PY{o}{=}\PY{n}{dog}\PY{p}{)}\PY{p}{)}
             \PY{n}{dog\PYZus{}breed\PYZus{}predictor}\PY{p}{(}\PY{n}{dog}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
A human was detected and it resembles a American\_foxhound

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_2.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A human was detected and it resembles a French\_bulldog

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_4.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A human was detected and it resembles a Silky\_terrier

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_6.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A human was detected and it resembles a American\_water\_spaniel

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_8.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
A human was detected and it resembles a Silky\_terrier
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_10.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A dog was detected and it resembles a English\_springer\_spaniel

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_12.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A dog was detected and it resembles a Collie

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_14.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A dog was detected and it resembles a Petit\_basset\_griffon\_vendeen

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_16.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A dog was detected and it resembles a American\_water\_spaniel

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_64_18.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
A dog was detected and it resembles a Greyhound
...
\textbf{Answer:} I am running this code on an amazon aws virtual machine
so it is not very easy to insert images from my computer. Instead in the
cell above I ran the algorithm on 5 random humans and 5 random dogs from
the original dataset and visualized the results.
